...
class Day03SolverTest {
    ...
    @Test
    fun `given my input it should answer 1626 to the first puzzle`() {
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart1(), CoreMatchers.`is`("1626"))
    }

    @Test
    fun `given the wiresInstruction "R8,U5,L5,D3" and "U7,R6,D4,L4" it should answer 6 to the first puzzle`() {
        val input = "R8,U5,L5,D3\nU7,R6,D4,L4"
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart1(), CoreMatchers.`is`("6"))
    }

    @Test
    fun `given the wiresInstruction "R75,D30,R83,U83,L12,D49,R71,U7,L72" and "U62,R66,U55,R34,D71,R55,D58,R83" it should answer 159 to the first puzzle`() {
        val input = "R75,D30,R83,U83,L12,D49,R71,U7,L72\nU62,R66,U55,R34,D71,R55,D58,R83"
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart1(), CoreMatchers.`is`("159"))
    }

    @Test
    fun `given the wiresInstruction "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51" and "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7" it should answer 135 to the first puzzle`() {
        val input =
            "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\nU98,R91,D20,R16,D67,R40,U7,R15,U6,R7"
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart1(), CoreMatchers.`is`("135"))
    }

    @Test
    fun `given my input it should answer 27330 to the second puzzle`() {
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart2(), CoreMatchers.`is`("27330"))
    }

    @Test
    fun `given the wiresInstruction "R8,U5,L5,D3" and "U7,R6,D4,L4" it should answer 30 to the second puzzle`() {
        val input = "R8,U5,L5,D3\nU7,R6,D4,L4"
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart2(), CoreMatchers.`is`("30"))
    }

    @Test
    fun `given the wiresInstruction "R75,D30,R83,U83,L12,D49,R71,U7,L72" and "U62,R66,U55,R34,D71,R55,D58,R83" it should answer 610 to the second puzzle`() {
        val input = "R75,D30,R83,U83,L12,D49,R71,U7,L72\nU62,R66,U55,R34,D71,R55,D58,R83"
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart2(), CoreMatchers.`is`("610"))
    }

    @Test
    fun `given the wiresInstruction "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51" and "U98,R91,D20,R16,D67,R40,U7,R15,U6,R7" it should answer 410 to the second puzzle`() {
        val input =
            "R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51\nU98,R91,D20,R16,D67,R40,U7,R15,U6,R7"
        val day03Solver = Day03Solver(input)

        assertThat(day03Solver.solvePart2(), CoreMatchers.`is`("410"))
    }
}